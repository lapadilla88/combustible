...
<section id="container">
	...
	<div class="form_register">
		...
		<form action="reportevaless.php" method="post" name="form1">
			...
			<br><select name="idvehiculo" id="idvehiculo" placeholder="Vehículo" class="tamano03">
			...
			<br><label for="tipo">SURTIDOR</label>			
			...
			?>
				<br><select name="idgrifo" id="idgrifo" placeholder="Grifo" class="tamano02" >
				<option value="">(Seleccionar)</option>
				<?php 
					if($result_rol > 0)
					{
						while ($rol = mysqli_fetch_array($query_rol)) {
				?>
						<option value="<?php echo $rol['idgrifo']; ?>"><?php echo $rol['nombregrifo']; ?></option>
				<?php 
							# code...
						}
				...
				<br><label for="tipo">Combustible</label>			
				...
				?>
					<br><select name="idcombustible" id="idcombustible" placeholder="Combustible" class="tamano02" >
					<option value="">(Seleccionar)</option>
					<?php 
						if($result_rol > 0)
						{
