...
<section id="container">
	...
	<div class="form_register">
			...
			<form action="reportemantenimientoo.php" method="post" name="form1">
        	...
        	<label for="numero">Fecha Final</label>
			  <input type="date" name="fechaf" id="fechaf" class="tamano04">
				...
				<br><label for="rol">Tipo Mantenimiento</label>
				<br><select name="idtipomantenimiento" id="idtipomantenimiento" placeholder="Tipo Mantenimiento" class="tamano02" >
				<option value="">(Seleccionar)</option>
				<?php 
					if($result_rol > 0)
					{
